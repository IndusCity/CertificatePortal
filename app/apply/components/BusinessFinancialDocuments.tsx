...
interface BusinessFinancialDocumentsProps {
...
export function BusinessFinancialDocuments({
register,
watch,
control,
handleInputFocus,
handleInputBlur
}: BusinessFinancialDocumentsProps) {
...
const documents = [
  "Your firm's federal tax returns and all related schedules 1st year",
  "Your firm's federal tax returns and all related schedules 2nd year",
  "Your firm's federal tax returns and all related schedules 3rd year",
  "Your firm's federal tax returns and all related schedules 4th year",
  "Your firm's federal tax returns and all related schedules 5th year",
  "Affiliates' federal tax returns and all related schedules 1st year",
  "Affiliates' federal tax returns and all related schedules 2nd year",
  "Affiliates' federal tax returns and all related schedules 3rd year",
  "Affiliates' federal tax returns and all related schedules 4th year",
  "Affiliates' federal tax returns and all related schedules 5th year",
  ...
  "Audited financial statements (if available) -OR- Year-end balance sheets and income statements for the past three years (or life of firm, if less than three years)",
...
const handleFile = async (file: File, documentName: string) => {
  ...
  try {
    ...
    const filePath = `business-financial-documents/${documentName}/${fileName}`
...
return (
  <Card className="w-full max-w-4xl mx-auto">
    <CardHeader>
      <CardTitle className="text-2xl font-bold">Business Financial Documents</CardTitle>
    </CardHeader>
    <CardContent>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <input
                        ...
                        onFocus={() => handleInputFocus(`businessFinancialDocuments.${index}`)}
