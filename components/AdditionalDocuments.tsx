...
try {
  ...
  const filePath = `additional-documents/${documentName}/${fileName}`
  ...
  setFileUploads(prev => ({
    ...prev,
    [documentName]: { ...prev[documentName], status: 'error', progress: 0 }
  }))
...
<Card className="w-full max-w-4xl mx-auto">
  <CardHeader>
    <CardTitle className="text-2xl font-bold">Additional Documents</CardTitle>
  </CardHeader>
  <CardContent>
    <p className="mb-4">
      You can upload as many or as few documents as are applicable to your firm's DBE submission, but you do NOT HAVE TO UPLOAD ANYTHING to this page in order to proceed and submit the application and should ONLY upload applicable documents on this page in special cases such as having made significant changes to your firm for which it is appropriate and necessary to submit supporting documentation to our office on those changes, or uploading documentation to support your firm's request for new NAICS codes.
    </p>
                ...
                <div className="text-center">
                  ...
                  >
                    ...
                    <input
                      ...
                      onFocus={() => handleInputFocus(`additionalDocuments.${index}`)}
