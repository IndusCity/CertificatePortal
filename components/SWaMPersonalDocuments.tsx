...
interface SWaMPersonalDocumentsProps {
...
export function SWaMPersonalDocuments({
register,
watch,
control,
handleInputFocus,
handleInputBlur
}: SWaMPersonalDocumentsProps) {
const [fileUploads, setFileUploads] = useState<{ [key: string]: FileUpload }>({})
const [dragActive, setDragActive] = useState<string | null>(null)
const { toast } = useToast()

const documents = [
  { name: "Proof of Identity", info: "Additional info about Proof of Identity" },
  { name: "Proof of U.S Citizenship or Permanent Residency", info: "Additional info about Proof of Citizenship" },
  { name: "Resumes of owners and officers", info: "Additional info about Resumes" },
  { name: "Professional Licenses and Permits", info: "Additional info about Licenses and Permits" },
  { name: "Proof of Contributions", info: "Additional info about Proof of Contributions" },
]
...
const handleFile = async (file: File, documentName: string) => {
  ...
  try {
    ...
    const filePath = `swam-personal-documents/${documentName}/${fileName}`
...
return (
  <Card className="w-full max-w-4xl mx-auto">
    <CardHeader>
      <CardTitle className="text-2xl font-bold">SWaM Personal Documents</CardTitle>
    </CardHeader>
    <CardContent>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <input
                        ...
                        onFocus={() => handleInputFocus(`swamPersonalDocuments.${index}`)}
