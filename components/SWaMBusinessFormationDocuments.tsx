...
interface SWaMBusinessFormationDocumentsProps {
...
export function SWaMBusinessFormationDocuments({
register,
watch,
control,
handleInputFocus,
handleInputBlur
}: SWaMBusinessFormationDocumentsProps) {
...
const documents = [
  { name: "Operating Agreement and any Amendments", info: "Additional info about Operating Agreement" },
  { name: "Certificate of Organization/Existence/Formation", info: "Additional info about Certificate" },
  { name: "Articles of Organization and any Amendments", info: "Additional info about Articles of Organization" },
  { name: "Certificate of Assumed/Fictitious Name", info: "Additional info about Assumed/Fictitious Name" },
]
...
const handleFile = async (file: File, documentName: string) => {
  ...
  try {
    ...
    const filePath = `swam-business-formation/${documentName}/${fileName}`
...
return (
  <Card className="w-full max-w-4xl mx-auto">
    <CardHeader>
      <CardTitle className="text-2xl font-bold">SWaM Business Formation Documents</CardTitle>
    </CardHeader>
    <CardContent>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <input
                        ...
                        onFocus={() => handleInputFocus(`swamBusinessFormationDocuments.${index}`)}
