...
const handleFile = async (file: File, documentName: string) => {
  ...
  try {
    ...
    const filePath = `personal-documents/${documentName}/${fileName}`
...
return (
  <Card className="w-full max-w-4xl mx-auto">
    <CardHeader>
      <CardTitle className="text-2xl font-bold">Personal Documents</CardTitle>
    </CardHeader>
    <CardContent>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <input
                        ...
                        onFocus={() => handleInputFocus(`personalDocuments.${index}`)}
