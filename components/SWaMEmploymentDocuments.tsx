...
interface SWaMEmploymentDocumentsProps {
...
export function SWaMEmploymentDocuments({
register,
watch,
control,
handleInputFocus,
handleInputBlur
}: SWaMEmploymentDocumentsProps) {
...
const documents = [
  { name: "Form 941 - First page of most recent 1st quarter", info: "Additional info about Form 941 1st quarter" },
  { name: "Form 941 - First page of most recent 2nd quarter", info: "Additional info about Form 941 2nd quarter" },
  { name: "Form 941 - First page of most recent 3rd quarter", info: "Additional info about Form 941 3rd quarter" },
  { name: "Form 941 - First page of most recent 4th quarter", info: "Additional info about Form 941 4th quarter" },
]
...
const handleFile = async (file: File, documentName: string) => {
  ...
  try {
    ...
    const filePath = `swam-employment-documents/${documentName}/${fileName}`
...
return (
  <Card className="w-full max-w-4xl mx-auto">
    <CardHeader>
      <CardTitle className="text-2xl font-bold">SWaM Employment Documents</CardTitle>
    </CardHeader>
    <CardContent>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <input
                        ...
                        onFocus={() => handleInputFocus(`swamEmploymentDocuments.${index}`)}
