...
interface GeneralSubmissionDocumentsProps {
...
export function GeneralSubmissionDocuments({
  register,
  watch,
  control,
  handleInputFocus,
  handleInputBlur
}: GeneralSubmissionDocumentsProps) {
  ...
  const documents = [
    ...
    "Notice of Change",
    "DBE and SBA 8(a) Certifications",
    "Interstate Certification Cover Letter",
    "UCP Directory Image",
  ...
  const handleFile = async (file: File, documentName: string) => {
    ...
    try {
      ...
      const filePath = `${documentName}/${fileName}`
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">General Submission Documents</CardTitle>
      </CardHeader>
      <CardContent>
                    ...
                    <div className="text-center">
                      ...
                      >
                        ...
                        <input
                          ...
                          onFocus={() => handleInputFocus(`generalSubmissionDocuments.${index}`)}
